 ...
 * contains the address of a C++ Object this Java object
 * corresponds to. All method calls of generated classes
 * are delegated to that corresponding C++ object.
 * 
 */
public abstract class NativeObject extends gen.javaglue.LoadLibraries implements INativeObject {

	/**
	 * Load native library
	 */
    /* Done with org.gen.javaglue base class.
	static {
	    System.loadLibrary("javaglue");
	}
    */
	/**
	...
	public void setInstancePointer(InstancePointer pInstance,
			boolean argRemote) {
	    if(pInstance == null)
		pInstance = new InstancePointer(0);
	 ...
	 */
	public void setInstancePointer(long pInstance, boolean createdByLibrary) {
		setInstancePointer(new InstancePointer(pInstance), createdByLibrary);
	}

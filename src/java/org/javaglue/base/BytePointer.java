...
public class BytePointer extends NumberPointer<Byte> {
     ...
     */
    public BytePointer(InstancePointer pointer, boolean remote) {
        super(pointer,remote);
    }
    /**
     * Create a new BytePointer pointing to the address passed, marked remote or not by flag.
     * @param pointer Address
     * @param remote Whether this is remote (allocated from C++) or not (allocated from Java).
     */
    public BytePointer(long pointer, boolean remote) {
        super(new InstancePointer(pointer),remote);
    }
    /**
     * This makes it easy to create a BytePointer that points to a particular value.
     ...
     */
    public BytePointer(long pointer) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof BytePointer) {
			return this._get(object.pointer) == ((BytePointer) obj)._get(object.pointer);			
		}

...
/**
 * Allows allocation of a memory region and accessing it byte wise.
 * 
 */
public class NativeByteBuffer extends NativeObject {
     ...
     */
    public NativeByteBuffer(InstancePointer pInstance) {
        super(pInstance);
    }
     ...
     */
    public NativeByteBuffer(InstancePointer pointer, boolean b) {
        super(pointer,b);
    }

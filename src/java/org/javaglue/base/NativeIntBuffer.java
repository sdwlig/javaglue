 ...
 * 
 */
public class NativeIntBuffer extends NativeObject {
     ...
     */
    public NativeIntBuffer(InstancePointer pInstance) {
        super(pInstance);
    }
     ...
     */
    public NativeIntBuffer(InstancePointer pointer, boolean b) {
        super(pointer,b);
    }
     ...
     */
    public NativeIntBuffer(int size) {
    ...
    private native int _getIndex(long pInstance, int index);
    ...
    private native void _setIndex(long pInstance, int index, int value);

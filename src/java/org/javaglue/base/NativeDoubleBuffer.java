 ...
 * 
 */
public class NativeDoubleBuffer extends NativeObject {
     ...
     */
    public NativeDoubleBuffer(InstancePointer pInstance) {
        super(pInstance);
    }
     ...
     */
    public NativeDoubleBuffer(InstancePointer pointer, boolean b) {
        super(pointer,b);
    }
     ...
     */
    public NativeDoubleBuffer(int size) {
    ...
    private native double _getIndex(long pInstance, int index);
    ...
    private native void _setIndex(long pInstance, int index, double value);

 ...
 * 
 */
public class NativeFloatBuffer extends NativeObject {
     ...
     */
    public NativeFloatBuffer(InstancePointer pInstance) {
        super(pInstance);
    }
     ...
     */
    public NativeFloatBuffer(InstancePointer pointer, boolean b) {
        super(pointer,b);
    }
     ...
     */
    public NativeFloatBuffer(int size) {
    ...
    private native float _getIndex(long pInstance, int index);
    ...
    private native void _setIndex(long pInstance, int index, float value);

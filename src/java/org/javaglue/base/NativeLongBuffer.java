...
public class NativeLongBuffer extends NativeObject {
     ...
     */
    public NativeLongBuffer(InstancePointer pInstance) {
        super(pInstance);
    }
     ...
     */
    public NativeLongBuffer(InstancePointer pointer, boolean b) {
        super(pointer,b);
    }
     ...
     */
    public NativeLongBuffer(int size) {
    ...
    private native long _getIndex(long pInstance, int index);
    ...
    private native void _setIndex(long pInstance, int index, long value);
